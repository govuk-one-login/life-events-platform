...
dependencies {
  ...
  implementation(platform("software.amazon.awssdk:bom:2.20.134"))
  ...
  implementation("org.javers:javers-spring:7.3.2")
  implementation("org.javers:javers-persistence-sql:7.3.2")
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.537") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
