...
module "data-share-service" {
  ...
  prisoner_search_client_id     = "gdx-data-share-poc"
  prisoner_search_client_secret = "***" // TODO:Needs secret injection
  prisoner_event_queue_name     = "dps-tech-dev-gds-data-share-queue"
  prisoner_event_dlq_name       = "dps-tech-dev-gds-data-share-dlq"
