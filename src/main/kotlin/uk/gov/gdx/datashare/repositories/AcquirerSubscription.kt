...
data class AcquirerSubscription(
  ...
  val acquirerId: UUID,
  @Schema(description = "Client ID used to access the event platform", required = false, example = "an-oauth-client", maxLength = 50, pattern = CLIENT_ID_REGEX)
  ...
  @Schema(description = "Indicates when the Acquirer Subscription was created", required = true, example = "2023-01-04T12:30:00")
