# This is copied from the AWS definition at https://github.com/awslabs/aws-config-rules/blob/master/aws-config-conformance-packs/Operational-Best-Practices-for-CIS-AWS-v1.4-Level1.yaml
resource "aws_config_conformance_pack" "cis_1_4" {
  name = "cis-1-4"
