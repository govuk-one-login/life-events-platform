...
dependencies {
  ...
  implementation("io.micrometer:micrometer-registry-cloudwatch2:1.10.4")
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.409") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
