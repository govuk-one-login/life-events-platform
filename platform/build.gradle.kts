...
dependencies {
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.522") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
