...
dependencies {
  ...
  implementation(platform("software.amazon.awssdk:bom:2.20.117"))
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.519") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
