  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { "name" : "API_BASE_PRISONER_SEARCH_API_CLIENT_ID", "value" : aws_ssm_parameter.prisoner_search_api_client_id.value },
        { "name" : "API_BASE_PRISONER_SEARCH_API_CLIENT_SECRET", "value" : aws_ssm_parameter.prisoner_search_api_client_secret.value },
        ...
        { "name" : "SQS_QUEUES_PRISONEREVENT_QUEUENAME", "value" : aws_ssm_parameter.prisoner_event_queue_name.value },
        { "name" : "SQS_QUEUES_PRISONEREVENT_DLQNAME", "value" : aws_ssm_parameter.prisoner_event_dlq_name.value },
        {
