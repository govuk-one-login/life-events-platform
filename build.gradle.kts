...
plugins {
  ...
  id("com.netflix.nebula.jakartaee-migration") version "0.5.0"
}
...
dependencies {
  ...
  implementation(platform("software.amazon.awssdk:bom:2.20.49"))
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.451") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
