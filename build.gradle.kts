...
dependencies {
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.425") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
