...
dependencies {
  ...
  implementation("org.javers:javers-spring:7.1.0")
  implementation("org.javers:javers-persistence-sql:7.1.0")
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.506") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
