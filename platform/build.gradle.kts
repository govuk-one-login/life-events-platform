...
dependencies {
  ...
  implementation("org.javers:javers-spring:7.0.3")
  implementation("org.javers:javers-persistence-sql:7.0.3")
  ...
  testImplementation("com.amazonaws:aws-java-sdk-core:1.12.505") // required for TestContainers https://github.com/testcontainers/testcontainers-java/issues/1442#issuecomment-694342883
