# This is copied from the AWS definition at https://github.com/awslabs/aws-config-rules/blob/master/aws-config-conformance-packs/Operational-Best-Practices-for-NCSC-CloudSec-Principles.yaml
resource "aws_config_conformance_pack" "ncsc_cloudsec_principles" {
  name = "ncsc-cloudsec-principles"
