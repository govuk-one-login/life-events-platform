...
class EventsController(
  ...
  @Operation(
    ...
    description = "Get count of all events for consumer, Need scope of data/consume",
    responses = [
      ApiResponse(
        responseCode = "200",
  ...
  @Operation(
    ...
    description = "Get all events for consumer, Need scope of data/consume",
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "Events"
